...
//{
//    std::cout << "in set layer" << std::endl;
...
//	bool& allow_soil_to_freeze = DTO.allow_runoff_from_infiltration;
...
//    else
//    {
//    std::cout << "in set layer to exit"  << std::endl;
//        DTO.thaw_fraction_rechr = 0.0;
//        DTO.thaw_fraction_lower = 0.0;
//        return;
//    };
//    
//    std::cout << "in set layer" << std::endl;
//    if (allow_soil_to_freeze || DTO.freeze_thaw_first_front == 0.0)
//    {
...
//    std::cout << "in set layer" << std::endl;
//
//    if (DTO.soil_storage_max > 0.0 && allow_soil_to_freeze  &&
